...
public class ReaderActivityLauncher {
     ...
     */
    public static void showReaderBlogPreview(Context context, SiteModel site) {
        if (site == null) {
            return;
        }

        AnalyticsUtils.trackWithBlogDetails(AnalyticsTracker.Stat.READER_BLOG_PREVIEWED, site);
