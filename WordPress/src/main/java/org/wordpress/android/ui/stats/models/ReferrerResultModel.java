...
public class ReferrerResultModel implements Serializable {
    ...
    public ReferrerResultModel(SiteModel site, String date, JSONObject resultJSON) throws JSONException {
        mSite = site;
        ...
        if (resultJSON.has("children")) {
            ...
            for (int i = 0; i < childrenJSON.length(); i++) {
                ...
                mChildren.add(getChildren(site, date, currentChild));
            }
    ...
    private SingleItemModel getChildren(SiteModel site, String date, JSONObject child) throws JSONException {
        String name = child.getString("name");
        int totals = child.getInt("views");
        String icon = JSONUtils.getString(child, "icon");
        String url = child.optString("url");
        return new SingleItemModel(site, date, null, name, totals, url, icon);
    }
